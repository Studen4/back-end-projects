    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if(Auth::check())
                    <div class="mr-4">
                        <p class="text-sm text-gray-800 dark:text-gray-200">Ласкаво просимо, {{ Auth::user()->username }}!</p>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Ваша роль: {{ Auth::user()->role }}</p>
                    </div>
                @endif
